 ...
 * @author manou
 */
public class GetDemandeEvenementForm extends SideMenuBaseForm  {
 SpanLabel sp = new SpanLabel();
DemandeEvenement d=new DemandeEvenement();
ArrayList<DemandeEvenement>de;
    public GetDemandeEvenementForm(Resources res) {
...
fab.addActionListener(e->new AddDemenedeEvenement(this).show());
        ...
        add(new Label("Listes des Evenementttt", "TodayTitle"));
        
        FontImage arrowDown = FontImage.createMaterial(FontImage.MATERIAL_KEYBOARD_ARROW_DOWN, "Label", 3);
       
 sp.setText(DemenedeEvenementService.getInstance().getAlldemandeEvenements().toString());
de=DemenedeEvenementService.getInstance().getAlldemandeEvenements();
for(DemandeEvenement d:de){
      addItem(d,res);
    }
...
//getToolbar().addMaterialCommandToLeftBar("",FontImage.MATERIAL_ARROW_BACK, e->this.showBack());
    ...
    public void addItem(DemandeEvenement d,Resources res){
Container c1=new Container(new BoxLayout(BoxLayout.Y_AXIS));
 FontImage arrowDown = FontImage.createMaterial(FontImage.MATERIAL_KEYBOARD_ARROW_DOWN, "Label", 3);
getToolbar().addMaterialCommandToLeftBar("",FontImage.MATERIAL_ARROW_BACK, e->this.showBack());
        addButtonBottom(arrowDown, d.getDescription_demande(), 0xd997f1, true,d);
...
//this.add(c1);
    ...
    private void addButtonBottom(Image arrowDown, String text, int color, boolean first,DemandeEvenement d) {
